...
import CompanyMessages from './CompanyMessages.jsx';
import CompanyCars from "../Company Profile/CompanyCars.jsx"
import CompanyInfo from "../Company Profile/CompanyInfo.jsx"
import ReceivedOrders from "../Company Profile/ReceivedOrders.jsx"
import EditCompanyInfo from "../Company Profile/EditCompanyInfo.jsx"
...
const CompanyProfile = () => {
    ...
    const renderContent = () => {
        switch (selectedTab) {
            ...
            case 'Messages':
                return <CompanyMessages messages={messages} companyId={company.id} setMessages={setMessages}/>;
            case 'EditCompanyInfo':
                return <EditCompanyInfo formData={formData} handleChange={handleChange} handleUpdate={handleUpdate} />;
            default:
    ...
    useEffect(() => {
        handleGetreq();
        handleGetcars(); // Initial fetch when component mounts
